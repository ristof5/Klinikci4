                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <img src="/assets/img/background.png" width="600" height="400">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="<?= base_url('/cek_login'); ?>" class="user">
                                        <?= csrf_field(); ?>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a href="<?= base_url('/register') ?>" class="btn btn-success btn-user btn-block" style="border-radius: 10rem;">
                                            Buat Akun
                                        </a>
                                        <?= csrf_field(); ?>
                                    </div>
